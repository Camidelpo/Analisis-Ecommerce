...
La empresa, dedicada a la venta y distribución en línea de productos diversos, ha experimentado una disminución sostenida en sus ventas durante los últimos tres años.
Con el objetivo de mejorar la rentabilidad y la eficiencia operativa, se propone el desarrollo de un proyecto de análisis del flujo de pagos, estructurado bajo la metodología SMART y apoyado en técnicas de análisis avanzado y proyección de datos.

El proyecto tiene como finalidad definir objetivos específicos, medibles, alcanzables, relevantes y temporales, orientados a:

identificar patrones de comportamiento en las transacciones,

detectar fallos en la efectivización de los pagos,

y anticipar escenarios futuros que contribuyan a optimizar el proceso comercial y la conversión de ventas.
